# oframe/scheduler/skill_graph.py
...
class SkillNode:
    def __init__(self, name: str, handler: str, dependencies: List[str] = None,
        ...
        self.trigger = trigger          # "cron", "interval", "probabilistic", "on_event"
...
class SkillGraph:
    ...
    def is_satisfied(self, skill_name: str) -> bool:
        # For now, assume dependencies are satisfied if they have been run at least once
        # Could be extended with timestamps or conditions
